...
class Employee(models.Model):
    TYPE_CHOICES =(('celibat','Célibataire'),('marie', 'Marié(e)'), ('divorce', 'Divorcé(e)'), ('veuf ','Veuf(ve)'), ('concubin', 'Concubinage'))
    ...
    status = models.CharField(max_length=255, blank=True, null=True, choices=TYPE_CHOICES, default='celibat')
...
class Contract(models.Model):
    ...
    contractupload = models.FileField(upload_to="ContractFile/contract.pdf", blank=True, null=True)
    createDate = models.DateTimeField(auto_now_add=True)
    updateDate = models.DateTimeField(auto_now=True)
