    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employeeMat', models.CharField(editable=False, max_length=30, unique=True)),
                ...
                ('photo', models.ImageField(blank=True, default='', null=True, upload_to='profiles/')),
                ...
                ('supervisor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Supervisor', to='HRM.employee')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documentref', models.CharField(editable=False, max_length=50, unique=True)),
                ('numCni', models.CharField(max_length=100, unique=True)),
                ('cniupload', models.FileField(upload_to='documents/cni/')),
                ('diploma', models.CharField(blank=True, max_length=255, null=True)),
                ('diplomaupload', models.FileField(upload_to='documents/diploma/')),
